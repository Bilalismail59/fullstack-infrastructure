...
# Script pour importer la dernière ressource et finaliser complètement
set -e

echo " IMPORTATION FINALE ET COMPLETION"
echo "=================================="

cd terraform

echo " Importation de la Global Forwarding Rule (dernière ressource)..."
terraform import google_compute_global_forwarding_rule.default "projects/primordial-port-462408-q7/global/forwardingRules/fullstack-app-forwarding-rule"

echo " Toutes les ressources importées!"
